...
Another class of interest is the Whistle class, where 72\% of glitches were correctly identified. Increasing the injected SNR from 27 to 50 raises the classification accuracy to 94\%, illustrating another case of strong SNR dependence of Gravity Spy classifications for this class.

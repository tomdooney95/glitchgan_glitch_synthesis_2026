...
\subsection{Classification evaluation using Gravity Spy}
...
We have demonstrated that class-conditional deep generative models can effectively synthesize realistic GW detector glitches directly in the time domain.
...
As GW detector networks mature and sensitivity improves, the ability to generate realistic instrumental noise backgrounds will become increasingly valuable for characterization and analysis algorithm development.
